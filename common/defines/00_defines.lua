...
NGame = {
	...
	CHECKSUM_SALT = "zwOdv5d9w39uDSOT",				-- Data to modify generated checksum when game binaries have changed but not any content files.
	LAG_DAYS_FOR_LOWER_SPEED = 10000,					-- Days of client lag for decrease of gamespeed
	LAG_DAYS_FOR_PAUSE = 250000,						-- Days of client lag for pause of gamespeed.
	GAME_SPEED_SECONDS = { 2.0, 0.5, 0.2, 0.1, 0.05 }, -- game speeds for each level. Must be 5 entries with last one 0 for unbound
...
NMilitary = {
	...
	CORPS_COMMANDER_DIVISIONS_CAP = 36,			-- how many divisions a corps commander is limited to. 0 = inf, < 0 = blocked
	...
	COMBAT_STACKING_START = 20,						-- at what nr of divisions stacking penalty starts
	COMBAT_STACKING_EXTRA = 20,                      -- extra stacking from directions
	COMBAT_STACKING_PENALTY = -0.20,                -- how much stackign penalty per division
...
NOperatives = {
	...
	AGENCY_CREATION_FACTORIES = 50000000,					-- Number of factories used to create an intelligence agency
	...
	AGENCY_OPERATIVE_RECRUITMENT_TIME = 30000000,			-- Number of days to wait to have operative to recruit when an operative slot first becomes available
